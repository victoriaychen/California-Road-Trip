...
<body onload="getInfo()">
	...
	<div id = "hero">
		San Francisco
		<form method='post' action='http://jasonxiang.great-site.net/final/SanFrancisco.php'>
		...
		<?php
			...
			//run a query
			if ($save_status == 'Save'){
				$sql = "UPDATE yourTrip SET saved = 1 WHERE city = 'SF'";
			}else{
				$sql = "UPDATE yourTrip SET saved = 0 WHERE city = 'SF'";
			}
