...
<style>
		...
		#hero {
			background-image: url("sandiego.jpeg");
...
<script>
		...
		request2.open("GET", "https://api.openweathermap.org/data/2.5/onecall?lat=32.715736&lon=-117.161087&exclude=hourly,daily&appid=6e477249e2b1e0f4d6461a66a1947eaa", true)
	    ...
	    function getAQI() {
            ...
            request.open("GET", "http://api.openweathermap.org/data/2.5/air_pollution?lat=32.715736&lon=-117.161087&appid=9eb8bd1cc3e0712eec15fc85f42632dd", true);
            console.log("2 - opened request file");
...
<body onload="getInfo()">
	...
	<div id = "hero">
		San Diego
		<form method='post' action='http://jasonxiang.great-site.net/final/SanDiego.php'>
		...
		<?php
			...
			//run a query
			if ($save_status == 'Save'){
				$sql = "UPDATE yourTrip SET saved = 1 WHERE city = 'SD'";
			}else{
				$sql = "UPDATE yourTrip SET saved = 0 WHERE city = 'SD'";
			}
	...
	<div class="container">
		<div class="block">
				...
				<div class="middle">
					...
					<div class="text">
						<p>West of downtown San Diego, is Point Loma, Harbor Island and Shelter Island, all of which offer restaurants, activities and attractions, a variety of accommodations and stunning views of San Diego’s skyline.</p>

					</div>
				</div>
				<h3 class="city">Point Loma</h3>
			...
			<div class="block">
				...
				<div class="middle">
					...
					<div class="text">
						<p>This is a must when visiting San Diego. Make time to drive here and watch the sun set. The cliffs are awe inspiring alone, but add in the ocean spray and you won't forget it.</p>
					</div>
				</div>
				<h3 class="city">Sunset Cliffs Natural Park</h3>
			...
			<div class="block">
				...
				<div class="middle">
					...
					<div class="text">
						<p>A once-in-a-lifetime opportunity to explore a historic aircraft carrier. Activities include tours, flight simulators, climb-in aircraft, ejection seats and cockpits, and more.</p>

					</div>
				</div>
				<h3 class="city">Midway Aircraft Carrier Museum</h3>
			</div>
	...
	<div class="container">
			<div class="block">
				<img class="image" src="images/seafood.jpg" alt="Truluck's Ocean's Finest">
				<div class="middle">

					<div class="text">
						<p>Truluck's Ocean's Finest<br/>
				...
				<h3 class="city">Truluck's Ocean's Finest</h3>
			</div>
			<div class="block">
				<img class="image" src="images/hod.jpg" alt="Hodad's Downtown">
				<div class="middle">

					<div class="text">
						<p>Hodad's Downtown<br/>
							945 Broadway
						</p>
					</div>
				</div>
				<h3 class="city">Hodad's Downtown</h3>

			</div>
			<div class="block">
				<img class="image" src="images/ita.jpg" alt="Parma Cucina Italiana">
				<div class="middle">

					<div class="text">
						<p>Parma Cucina Italiana<br/>
							3850 5th Ave</p>

					</div>
				</div>
				<h3 class="city">Parma Cucina Italiana</h3>
			</div>
	</div>
