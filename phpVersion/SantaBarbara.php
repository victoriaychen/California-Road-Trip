...
<style>
		...
		#hero {
			...
			background-image: url("images/sbb.jpg");
...
<script>
		...
		request2.open("GET", "https://api.openweathermap.org/data/2.5/onecall?lat=34.420830&lon=	-119.698189&exclude=hourly,daily&appid=6e477249e2b1e0f4d6461a66a1947eaa", true)
		...
		function getSun() {
			...
			request1.open("GET", "https://api.sunrise-sunset.org/json?lat=34.420830&lng=-119.698189", true)
	    ...
	    function getAQI() {
            ...
            request.open("GET", "http://api.openweathermap.org/data/2.5/air_pollution?lat=34.420830&lon=-119.698189&appid=9eb8bd1cc3e0712eec15fc85f42632dd", true);
            console.log("2 - opened request file");
...
<body onload="getInfo()">
	...
	<div id = "hero">
		Santa Barbara
		<form method='post' action='http://jasonxiang.great-site.net/final/SantaBarbara.php'>
		...
		<?php
			...
			//run a query
			if ($save_status == 'Save'){
				$sql = "UPDATE yourTrip SET saved = 1 WHERE city = 'SB'";
			}else{
				$sql = "UPDATE yourTrip SET saved = 0 WHERE city = 'SB'";
			}
	...
	<div class="container">
		<div class="block">
				<img class="image" src="images/old.jpg" alt="old mission">
				<div class="middle">

					<div class="text">
						<p>Mission Santa Barbara is a Spanish mission in Santa Barbara, California.</p>

					</div>
				</div>
				<h3 class="city">Old Mission Santa Barbara</h3>
			</div>
			<div class="block">
				<img class="image" src="images/shore.jpg" alt="Shoreline Park">
				<div class="middle">

					<div class="text">
						<p>Facing the Pacific Ocean, Shoreline Park is one of Santa Barbara's most popular parks.</p>
					</div>
				</div>
				<h3 class="city">Shoreline Park</h3>

			</div>
			<div class="block">
				<img class="image" src="images/mus.jpg" alt="Santa Barbara Museum of Natural History">
				<div class="middle">

					<div class="text">
						<p>It reconnects more than 150,000 people each year to nature indoors and outdoors.</p>

					</div>
				</div>
				<h3 class="city">Santa Barbara Museum of Natural History</h3>
			</div>
	...
	<div class="container">
			<div class="block">
				<img class="image" src="images/r8.jpg" alt="Truluck's Ocean's Finest">
				<div class="middle">

					<div class="text">
						<p>East Beach Tacos<br/>
							226 S Milpas St
				...
				<h3 class="city">East Beach Tacos</h3>
			</div>
			<div class="block">
				<img class="image" src="images/r9.jpg" alt="Hodad's Downtown">
				<div class="middle">

					<div class="text">
						<p>Cold Spring Tavern<br/>
							5995 Stagecoach Rd
						</p>
					</div>
				</div>
				<h3 class="city">Cold Spring Tavern</h3>

			</div>
			<div class="block">
				<img class="image" src="images/r10.jpg" alt="Parma Cucina Italiana">
				<div class="middle">

					<div class="text">
						<p>Handlebar Coffee Roasters<br/>
							2720 De La Vina St Mid-Town</p>

					</div>
				</div>
				<h3 class="city">Handlebar Coffee Roasters</h3>
			</div>
	</div>
